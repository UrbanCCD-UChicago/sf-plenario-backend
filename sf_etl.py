...
if __name__ == "__main__":
    ...
    add_dataset_meta('sf_community_centers_nonstatic',\
        human_name='Community centers (non static)',\
        count_q=True, dist_q=True, demo=True)
    ...
    add_dataset_meta('sf_violent_crimes', human_name='Violent crimes',
        count_q=True, dist_q=True, duration='event')
